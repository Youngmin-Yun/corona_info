...
<body>
    <div class="left_menu">
        ...
        <ul class = "main_menu">
            ...
            <li>
                <a href="/international/info">International Info <span>국제 코로나정보</span></a>
            </li>
            <li>
                <a href="/veccineCenter">Veccine Center <span>접종센터 정보</span></a>
            </li>
            <li>
                <a href="/vaccineCenter/consigned">Consigned Center <span>위탁 접종센터</span></a>
            </li>
        </ul>
    </div>
</body>
