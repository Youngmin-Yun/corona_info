            ...
            success: function (r) {
                ...
                for (let i = 1; i < r.vaccineList.length; i++) {
                    let tag =
                        ...
                        '<p class = "sidoFirst">' +
                        '<span>1차 : </span>' +
                        '<span class = "sidoAccCnt">' + comma(r.vaccineList[i].accFirstCnt) + '</span>' +
                        '<span class = "sidoIncCnt">' + comma(r.vaccineList[i].firstCnt) + ' ▲</span>' +
                        '</p>' +
                        '<p class = "sidoSecond">' +
                        '<span>완료 : </span>' +
                        '<span class = "sidoAccCnt">' + comma(r.vaccineList[i].accSecondCnt) + '</span>' +
                        '<span class = "sidoIncCnt">' + comma(r.vaccineList[i].secondCnt) + ' ▲</span>' +
                        '</p>' +
                        '</div>'
